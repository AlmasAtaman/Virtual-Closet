        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-gray-50 to-white px-4 py-12">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-200 p-8 sm:p-10 flex flex-col gap-6">
                ...
                <div className="flex justify-center gap-6 mb-4 border-b border-gray-200 pb-2">
                    <Link href="/signup" className="text-lg font-semibold text-gray-400 hover:text-black transition">Sign-Up</Link>
                    <span className="text-lg font-bold text-gray-900 border-b-2 border-black pb-1">Log In</span>
                </div>
                {/* Social Buttons */}
                ...
                <div className="text-xs text-gray-500 text-center mt-2">
                    By logging in, you agree to the <a href="#" className="underline hover:text-black">Terms of Service</a> and <a href="#" className="underline hover:text-black">Privacy Policy</a>.
                </div>
                {/* Go Back */}
