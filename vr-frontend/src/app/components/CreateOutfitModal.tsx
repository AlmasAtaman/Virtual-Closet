...
import { X, Shuffle, Check, AlertTriangle, Plus } from 'lucide-react';
            ...
            {show && (
                ...
                >
                    <motion.div
                        ...
                        className="bg-white dark:bg-slate-900 rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden"
                                    ...
                                    <Card className="h-[500px]">
                                        <CardContent className="h-full p-6">
                                            <div className="h-full relative bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-xl flex items-center justify-center">
                                                ...
                                                <motion.div
                                                    key={`outfit-preview-${animationKey || 'fallback'}`}
                                                ...
                                                >
                                                    ...
                                                    {selectedBottom && (
                                                        <motion.img
                                                            key={`bottom-${selectedBottom?.id || 'fallback-bottom'}`}
                                                    ...
                                                    {selectedTop && (
                                                        <motion.img
                                                            key={`top-${selectedTop?.id || 'fallback-top'}`}
                                                            initial={{ opacity: 0, y: 20 }}
                                                            animate={{ opacity: 1, y: 0 }}
                                                    ...
                                                    {selectedOuterwear && (
                                                        <motion.img
                                                            key={`outerwear-${selectedOuterwear?.id || 'fallback-outerwear'}`}
                                                            initial={{ opacity: 0, y: 20 }}
                                                            animate={{ opacity: 1, y: 0 }}
                                                    ...
                                                    {selectedShoe && (
                                                        <motion.img
                                                            key={`shoe-${selectedShoe?.id || 'fallback-shoe'}`}
                                                            initial={{ opacity: 0, y: 20 }}
                                                            animate={{ opacity: 1, y: 0 }}
                                                            transition={{ delay: 0.1 }}
