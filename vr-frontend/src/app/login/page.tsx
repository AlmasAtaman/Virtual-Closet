...
import { FaGoogle, FaFacebookF, FaApple, FaUser, FaLock } from "react-icons/fa";
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-200 p-8 sm:p-10 flex flex-col gap-6">
                ...
                <form onSubmit={checkUser} className="flex flex-col gap-4">
                    ...
                    >
                        ...
                        <span className="relative z-10 transition-colors duration-200 group-hover:text-black">Sign In</span>
                    </button>
                </form>
                {/* Terms/Privacy */}
